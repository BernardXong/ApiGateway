...
/**
 * @Author: Bernie
 * @CreateTime: 2020-01-08 17:51
 * @Description:
 * @Email: yun.xiong@51wph.com
 */
@Slf4j
@Component
public class RedisUtil {
    ...
    /**
     * 对 redis 中指定 key相关的key进行查询返回
     *
     * @param prefixKey  模糊查询的键，不能为null
     * @return
     */
    public Set<String> keys(String prefixKey){
        prefixKey = prefixKey + StringSymbol.START;
        return this.redisTemplate.keys(prefixKey);
    }
